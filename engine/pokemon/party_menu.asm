...
; BUGfixed: Only the first three evolution entries can have Stone compatibility reported correctly (see docs/bugs_and_glitches.md)
	...
	ld hl, wStringBuffer1
.loop2
; BUGfixed: EVOLVE_STAT can break Stone compatibility reporting (see docs/bugs_and_glitches.md)
	ld a, [hli]
	and a
	jr z, .nope
	cp EVOLVE_STAT
...
;	db "@";"　ばんめ　　@" ; Place
.String_Able:
	db "CAPACE@";"さんかしない@" ; Cancel
.String_NotAble:
	db "INCAPACE@"
.String_Kettei_Yameru:
	db "OK  ESCI@";"けってい　　やめる@" ; Quit
.Strings_1_2_3:
	db "PRIMO @", "SECONDO@", "TERZO @" ; 1st, 2nd, 3rd
