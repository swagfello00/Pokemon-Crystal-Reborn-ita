...
.CantCheckEggMoves:
	text "Non puoi vedere le"
	line "mosse di un UOVO!"
	prompt
...
.ReallyReleaseBox:
	text "Vuoi davvero"
	line "liberare l'intero"
	cont "BOX?"
	done

.CantRecallReleasedMons:
	text "Non potranno"
	line "tornare indietro,"
	cont "Sei sicuro?"
	done
...
.CantStoreMail:
	text "Non puoi mettere i"
	line "messaggi nei BOX."
	prompt

BillsPC_LastPartyMon:
	text "È il tuo ultimo"
	line "#MON utile!"
	prompt
