...
; and the "TYPE/", "EFF/", "ACC/" and "ATK/" strings.
...
MoveReminderIntroText:
	...
	para "Per ¥2500, posso"
	line "far ricordare una"
	
	para "mossa a un tuo"
	line "#MON."

	para "Sei interessato?"
	done
...
MoveReminderNoMovesText:
	text "Non ci sono mosse"
	line "da imparare per"
	cont "questo #MON."
	done
