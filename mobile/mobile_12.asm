...
TellNowTellLaterMenu:
	...
	ld [wMenuCursorY], a
	hlcoord 9, 8 ; Placement of 'Tell Now' 'Tell Later' Box
	ld b, $4
	ld c, $9
	call DisplayBlankGoldenBox
	hlcoord 11, 10 ; Placement of 'Tell Now' 'Tell Later' Text
...
MenuHeader_0x48a9c:
	db MENU_BACKUP_TILES ; flags
	menu_coords 9, 8, SCREEN_WIDTH - 1, 13 ; For clearing the 'Tell Later' 'Tell Now' Box
