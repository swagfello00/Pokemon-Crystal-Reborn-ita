...
; wDailyRematchFlags
	...
	const ENGINE_FALKNER_REMATCH_DONE
	const ENGINE_BUGSY_REMATCH_DONE
	const ENGINE_WHITNEY_REMATCH_DONE
	const ENGINE_MORTY_REMATCH_DONE
	const ENGINE_CHUCK_REMATCH_DONE
	const ENGINE_JASMINE_REMATCH_DONE
	const ENGINE_PRYCE_REMATCH_DONE
	const ENGINE_CLAIR_REMATCH_DONE
	const ENGINE_BROCK_REMATCH_DONE
	const ENGINE_MISTY_REMATCH_DONE
	const ENGINE_SURGE_REMATCH_DONE
	const ENGINE_ERIKA_REMATCH_DONE
	const ENGINE_JANINE_REMATCH_DONE
	const ENGINE_SABRINA_REMATCH_DONE
	const ENGINE_BLAINE_REMATCH_DONE
	const ENGINE_BLUE_REMATCH_DONE
