...
; New to Crystal Reborn
	...
	const EVENT_ROUTE_41_UNDERWATER_PEARL
	const EVENT_FUCHSIA_CITY_LUCKY_PUNCH
	const EVENT_BLACKTHORN_CITY_TM_PSYCH_UP
	const EVENT_ROUTE_32_SILVERPOWDER
	const EVENT_ROUTE_32_KINGS_ROCK
	const EVENT_ROUTE_22_TWISTEDSPOON
	const EVENT_ROUTE_33_SLOWPOKETAIL
	const EVENT_ROUTE_3_STICK
	const EVENT_ROUTE_32_SCOPE_LENS
	const EVENT_LAVENDER_TOWN_POLKADOT_BOW
	const EVENT_ROUTE_42_WATER_STONE
	const EVENT_SILVER_CAVE_OUTSIDE_BRIGHTPOWDER
	const EVENT_BLACKTHORN_CITY_SUN_STONE
	const EVENT_CINNABAR_ISLAND_FIRE_STONE
	const EVENT_ROUTE_46_LEAF_STONE
	const EVENT_ROUTE_27_SUN_STONE
	const EVENT_ROUTE_20_WATER_STONE
	const EVENT_ROUTE_10_BRICK_PIECE
	const EVENT_SILVER_CAVE_OUTSIDE_SILVER_LEAF
	const EVENT_SILVER_CAVE_OUTSIDE_GOLD_LEAF
	const EVENT_ROUTE_9_THICK_CLUB
	const EVENT_ROUTE_33_BERRY_JUICE
	const EVENT_ROUTE_10_NORTH_LIGHT_BALL
	const EVENT_ROUTE_23_METAL_POWDER
	const EVENT_TEAM_ROCKET_BASE_B2F_MACHINERY
	const EVENT_VIRIDIAN_FOREST_LEAF_STONE
	const EVENT_SEAFOAM_ISLANDS_B1F_ICE_HEAL
	const EVENT_SEAFOAM_ISLANDS_B1F_REVIVE
	...
	const EVENT_SEAFOAM_ISLANDS_B4F_TM_BLIZZARD
	const EVENT_SEAFOAM_ISLANDS_B4F_ULTRA_BALL
	const EVENT_VICTORY_ROAD_TM_FIRE_BLAST
	...
	const EVENT_CERULEAN_CAVE_2F_TM_HYPER_BEAM
	...
	const EVENT_ROCKET_HIDEOUT_B1F_CALCIUM
	...
	const EVENT_ROCKET_HIDEOUT_B3F_ELIXER
	const EVENT_ROCKET_HIDEOUT_B3F_CARBOS
	const EVENT_ROCKET_HIDEOUT_B3F_HIDDEN_FULL_HEAL
	const EVENT_ROCKET_HIDEOUT_B4F_TM_DOUBLE_TEAM
	const EVENT_ROCKET_HIDEOUT_B4F_PP_UP
	const EVENT_ROCKET_HIDEOUT_B4F_X_SPECIAL
	const EVENT_ROCKET_HIDEOUT_B4F_HIDDEN_MAX_POTION
	const EVENT_ROCKET_HIDEOUT_B4F_SILPH_SCOPE
	const EVENT_POWER_PLANT_2F_HP_UP
	const EVENT_POWER_PLANT_2F_RARE_CANDY
	const EVENT_POWER_PLANT_2F_CARBOS
	const EVENT_POWER_PLANT_2F_MAX_POTION
	const EVENT_POWER_PLANT_2F_TM_THUNDER
	const EVENT_POWER_PLANT_2F_ELECTRODE_1
	const EVENT_POWER_PLANT_2F_ELECTRODE_2
	const EVENT_POWER_PLANT_2F_ELECTRODE_3
	const EVENT_POWER_PLANT_2F_ELECTRODE_4
	const EVENT_POWER_PLANT_2F_ELECTRODE_5
	const EVENT_POWER_PLANT_2F_ELECTRODE_6
	const EVENT_POWER_PLANT_2F_ELECTRODE_7
	const EVENT_POWER_PLANT_2F_ELECTRODE_8
	const EVENT_POWER_PLANT_2F_HIDDEN_PP_UP
	const EVENT_POWER_PLANT_2F_HIDDEN_MAX_ELIXER
...
; New to Crystal Reborn
	...
	const EVENT_SILVER_CAVE_OUTSIDE_MEWTWO
	const EVENT_GOT_SQUIRTLE
	const EVENT_GOT_BULBASAUR
	const EVENT_GOT_CHARMANDER
	const EVENT_GOT_RIVAL_STARTER
	const EVENT_GAVE_SCIENTIST_OLD_AMBER
	const EVENT_GAVE_SCIENTIST_DOME_FOSSIL
	const EVENT_GAVE_SCIENTIST_HELIX_FOSSIL
	const EVENT_SAFARI_ZONE_BETA_MEW
	const EVENT_SAFARI_ZONE_BETA_PHONE
	const EVENT_AMPHY_LUCKY_EGG
	const EVENT_NORMALBOX
	const EVENT_GORGEOUSBOX
	const EVENT_VIOLET_MOBILE_EGG
	...
	const EVENT_REMATCH_CELEBI
	const EVENT_KANTO_SUICUNE
	const EVENT_KANTO_STARTERS
	const EVENT_BOULDER_IN_BLACKTHORN_GYM_4
	const EVENT_GAVE_SCIENTIST_MACHINERY
	const EVENT_OPENED_ROCKET_HIDEOUT
	const EVENT_ROCKET_HIDEOUT_DOORS_OPEN
	const EVENT_EASTER_EGG_BURIEDALIVE_OPEN
	const EVENT_POKEMON_TOWER_BURIEDALIVE
	const EVENT_ROUTE_3_FAT_MAGIKARP
	const EVENT_ROUTE_3_FAT_PIKACHU
