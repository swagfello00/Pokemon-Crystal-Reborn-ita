	...
	tilepal 0, RED, GRAY, GRAY, GRAY, GRAY, GREEN, GREEN, GRAY
	...
	tilepal 0, BROWN, BROWN, GRAY, RED, GRAY, GRAY, GRAY, GRAY

rept 16
	db $ff
endr

	tilepal 1, ROOF, BROWN, RED, TEXT, BROWN, TEXT, BROWN, TEXT
