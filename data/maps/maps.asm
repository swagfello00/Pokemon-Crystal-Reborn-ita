...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, ROUTE, LANDMARK_SAFARI, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map VictoryRoad, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslands1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map RocketHideoutB1F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map RocketHideoutB2F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map RocketHideoutB3F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map RocketHideoutB4F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map RocketHideoutElevator, TILESET_UNDERGROUND, DUNGEON, LANDMARK_CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PowerPlant2F, TILESET_UNDERGROUND, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower6F, TILESET_POKEMON_TOWER, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower7F, TILESET_POKEMON_TOWER, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map VictoryRoad2F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map Route3Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_3, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route10South, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10_SOUTH, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_PARK, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Underwater:
	...
	map Route41Underwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_UNDERWATER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map Route41UnderwaterCave, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_UNDERWATER, TRUE, PALETTE_NITE, FISHGROUP_NONE
