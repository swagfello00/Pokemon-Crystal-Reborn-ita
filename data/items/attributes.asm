...
; ANTIDOTE
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURN_HEAL
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_HEAL
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; AWAKENING
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; PARLYZ_HEAL
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL_RESTORE
	item_attribute 3000, HELD_NONE, -1, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_POTION
	item_attribute 2500, HELD_NONE, -1, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; HYPER_POTION
	item_attribute 1200, HELD_NONE, 200, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; SUPER_POTION
	item_attribute 700, HELD_NONE, 50, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; POTION
	item_attribute 300, HELD_NONE, 20, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; ESCAPE_ROPE
...
; MAX_ELIXER
	item_attribute 4500, HELD_NONE, -1, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; FIRE_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; THUNDERSTONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; FULL_HEAL
	item_attribute 600, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVE
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_REVIVE
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; GUARD_SPEC
...
; ITEM_2D
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FRESH_WATER
	item_attribute 200, HELD_NONE, 50, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; SODA_POP
	item_attribute 300, HELD_NONE, 60, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEMONADE
	item_attribute 350, HELD_NONE, 80, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; X_ATTACK
...
; PP_UP
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ETHER
	item_attribute 1200, HELD_NONE, 10, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_ETHER
	item_attribute 2000, HELD_NONE, -1, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; ELIXER
	item_attribute 3000, HELD_NONE, 10, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; RED_SCALE
...
; SILVER_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MOOMOO_MILK
	item_attribute 500, HELD_NONE, 100, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; QUICK_CLAW
...
; ITEM_78
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
	item_attribute 500, HELD_NONE, 50, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGY_ROOT
	item_attribute 800, HELD_NONE, 200, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; HEAL_POWDER
	item_attribute 450, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVAL_HERB
	item_attribute 2800, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; HARD_STONE
...
; BERRY_JUICE
	item_attribute 100, HELD_BERRY, 20, CANT_SELECT, MEDS, ITEMMENU_PARTY, ITEMMENU_PARTY
; SCOPE_LENS
...
; ITEM_9B
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SACRED_ASH
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, MEDS, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; HEAVY_BALL
...
; MIRAGE_MAIL
	item_attribute 50, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_BE
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
	assert_table_length NUM_ITEMS
; TM01
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM02
	item_attribute 2000, HELD_NONE, 0, NO_LIMITS, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM03
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM04
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; ITEM_C3
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM05
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM06
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM07
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM08
	item_attribute 1000, HELD_NONE, 0, NO_LIMITS, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM09
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; TM10
...
; TM12
	item_attribute 1000, HELD_NONE, 0, NO_LIMITS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM13
...
; TM27
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM28
	item_attribute 2000, HELD_NONE, 0, NO_LIMITS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ITEM_DC
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TM29
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
