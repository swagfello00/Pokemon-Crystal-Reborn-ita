	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, DEFENSE_CURL, REST, ATTRACT, FIRE_PUNCH, STRENGTH, FLAMETHROWER, DOUBLE_EDGE, ROCK_SLIDE, SUBSTITUTE, MEGA_PUNCH, COUNTER, THUNDERPUNCH, BODY_SLAM, METRONOME, MIMIC, SEISMIC_TOSS, SUBMISSION, ICE_PUNCH, SLUDGE_BOMB, EXPLOSION
	; end
