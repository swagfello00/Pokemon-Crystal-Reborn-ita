	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, IRON_TAIL, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, DETECT, REST, ATTRACT, CUT, FLASH, HEAL_BELL, REFLECT, LIGHT_SCREEN, BODY_SLAM, SWORDS_DANCE, COUNTER, SUBSTITUTE, DOUBLE_EDGE, FURY_CUTTER, MIMIC, OUTRAGE, SWIFT, MIRROR_COAT, ROCK_SLIDE, FALSE_SWIPE
	; end
