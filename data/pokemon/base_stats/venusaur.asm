	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, TOXIC, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, HYPER_BEAM, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, DEFENSE_CURL, REST, ATTRACT, FURY_CUTTER, CUT, FLASH, DOUBLE_EDGE, LIGHT_SCREEN, SLUDGE_BOMB, SWORDS_DANCE, SUBSTITUTE, BODY_SLAM, FALSE_SWIPE, MIMIC, REFLECT, ROCK_SMASH, STRENGTH, OUTRAGE, EARTHQUAKE, DIG, SHADOW_BALL
	; end
