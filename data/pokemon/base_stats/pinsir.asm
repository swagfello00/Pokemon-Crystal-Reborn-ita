	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, RETURN, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, REST, ATTRACT, THIEF, FURY_CUTTER, CUT, STRENGTH, RAIN_DANCE, EARTHQUAKE, FALSE_SWIPE, SWORDS_DANCE, ROCK_SLIDE, SUBSTITUTE, BODY_SLAM, DOUBLE_EDGE, MIMIC, SEISMIC_TOSS, OUTRAGE, SUBMISSION
	; end
