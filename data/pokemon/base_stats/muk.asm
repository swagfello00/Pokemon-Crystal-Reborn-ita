	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, CURSE, TOXIC, ZAP_CANNON, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, THUNDER, RETURN, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, FIRE_BLAST, THUNDERPUNCH, REST, ATTRACT, THIEF, FIRE_PUNCH, FLAMETHROWER, THUNDERBOLT, RAIN_DANCE, SHADOW_BALL, EXPLOSION, ROCK_SLIDE, SUBSTITUTE, PAIN_SPLIT, THUNDER_WAVE, BODY_SLAM, STRENGTH, DIG, MIMIC, HEADBUTT, ROCK_SMASH, MEGA_PUNCH, SOLARBEAM, DOUBLE_EDGE
	; end
