	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, SOLARBEAM, THUNDER, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, FLASH, THUNDERBOLT, MIMIC, SUBSTITUTE, REFLECT, LIGHT_SCREEN, ICY_WIND, BODY_SLAM, COUNTER, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, METRONOME, SEISMIC_TOSS, SUBMISSION, THUNDER_WAVE, RAIN_DANCE, MIRROR_COAT, TRI_ATTACK
	; end
