	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, FIRE_BLAST, DEFENSE_CURL, DREAM_EATER, DETECT, REST, ATTRACT, NIGHTMARE, FLASH, FLAMETHROWER, REFLECT, LIGHT_SCREEN, THUNDER_WAVE, SUBSTITUTE, HEAL_BELL, PAIN_SPLIT, BODY_SLAM, COUNTER, DIG, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, MIMIC, SEISMIC_TOSS, SUBMISSION, TRI_ATTACK, MIRROR_COAT, SOFTBOILED
	; end
