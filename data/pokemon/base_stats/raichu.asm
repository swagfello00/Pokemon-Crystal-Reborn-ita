	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, HIDDEN_POWER, SNORE, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, DETECT, REST, ATTRACT, THIEF, STRENGTH, FLASH, THUNDERBOLT, THUNDER_WAVE, LIGHT_SCREEN, SUBSTITUTE, BODY_SLAM, COUNTER, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, MIMIC, SEISMIC_TOSS, DIG, ROCK_SMASH, SUBMISSION, REFLECT, FIRE_PUNCH, ICE_PUNCH, PSYCHIC_M, DREAM_EATER
	; end
