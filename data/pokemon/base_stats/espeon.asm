	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, DREAM_EATER, DETECT, REST, ATTRACT, NIGHTMARE, CUT, FLASH, DOUBLE_EDGE, SUBSTITUTE, BODY_SLAM, MIMIC, DIG, REFLECT, HEAL_BELL, STRENGTH, ROCK_SMASH, LIGHT_SCREEN, MIRROR_COAT, ROAR, PAIN_SPLIT
	; end
