	...
	; tm/hm learnset
	tmhm CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, REST, ATTRACT, THIEF, CUT, TRI_ATTACK, SANDSTORM, ROCK_SLIDE, SUBSTITUTE, HEADBUTT, BODY_SLAM, DOUBLE_EDGE, MIMIC, SWIFT, FURY_CUTTER, FALSE_SWIPE, SUBMISSION, SEISMIC_TOSS
	; end
