	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, FIRE_BLAST, THUNDERPUNCH, DETECT, REST, ATTRACT, THIEF, FIRE_PUNCH, STRENGTH, FLAMETHROWER, SEISMIC_TOSS, SUBMISSION, COUNTER, LIGHT_SCREEN, ROCK_SLIDE, SUBSTITUTE, BODY_SLAM, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, METRONOME, MIMIC, SLUDGE_BOMB, RAIN_DANCE
	; end
