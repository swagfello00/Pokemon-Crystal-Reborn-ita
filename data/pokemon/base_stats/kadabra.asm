	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, RETURN, DIG, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, FLASH, LIGHT_SCREEN, REFLECT, THUNDER_WAVE, SUBSTITUTE, IRON_TAIL, BODY_SLAM, COUNTER, DOUBLE_EDGE, MEGA_KICK, MEGA_PUNCH, METRONOME, MIMIC, SEISMIC_TOSS, SUBMISSION, TRI_ATTACK
	; end
