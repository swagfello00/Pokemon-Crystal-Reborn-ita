...
; BUGfixed: LoadMetatiles wraps around past 128 blocks (see docs/bugs_and_glitches.md)
	ld l, a
	ld h, 0
	add hl, hl
	add hl, hl
...
; BUGfixed: ReadObjectEvents overflows into wObjectMasks (see docs/bugs_and_glitches.md)
	ld a, [wCurMapObjectEventCount]
	ld c, a
	ld a, NUM_OBJECTS - 1
	sub c
